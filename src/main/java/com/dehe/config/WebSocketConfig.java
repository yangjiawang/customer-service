...
import com.dehe.Interceptor.HttpHandShakeIntecepter;
import com.dehe.Interceptor.SocketChannelIntecepter;
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
	...
	public void registerStompEndpoints(StompEndpointRegistry registry) {
		...
		registry.addEndpoint("/app/v1/single/chat").setAllowedOrigins("*").withSockJS();
	}
	...
	public void configureClientInboundChannel(ChannelRegistration registration) {
		registration.interceptors( new SocketChannelIntecepter(redisClient));
	}
	@Override
